...
killall Terminal
 ...
 chmod 777 futurerestore180
 ./futurerestore180 -t blob.shsh2 --latest-sep --latest-baseband restore.ipsw
 clear
 echo "Your Device Should be Restored"
 echo "RestoreM8-2.0 By 80036nd"
 echo "Futurerestore v180 by tihmstar and s0uthwest"
